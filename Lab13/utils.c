...
void Do_Beep_Good()     // Same as do Beep but using the 2KHz buzzer activation
{
...
void Do_Beep_Bad()      // Same as do Beep but using the 500 hz buzzer activation
{
...
float read_volt()
{
     ...
     float voltage_mv= nStep * 5 ;
     float voltage = voltage_mv/1024.0;
     return voltage;
}
...
void Init_ADC()
{
    ADCON0 = 0x01;                      // Set the correct ADCONS
    ADCON1= 0x0E;
    ADCON2= 0xA9;
}
