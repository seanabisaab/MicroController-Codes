...
void Do_Setup_Alarm_Time(void)
{
    ...
    {   
         if (check_for_button_input() == 1)
         {
             ...
             {                                  // Set the proper buttons and do a good beep
                Do_Beep_Good();
...
void Increase_Alarm_Time()
{
            switch (Select_Alarm_Field)             // Increment the proper field
            {
                ...
                case 1:
                    ...
                    setup_alarm_minute++;                                       // add code here to handle minute increment
                    if(setup_alarm_minute == 60) setup_alarm_minute = 0;
                    break;
                case 2:
                    // increment the alarm second
                    setup_alarm_second++;
...
{ 
    ...
    strcpy(txt, "ECE3301L S1 Final");                     // Text displayed 
