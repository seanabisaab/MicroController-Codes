...
void Do_Setup_Time(void)
{
    ...
    {  
         if (check_for_button_input() == 1)
         {
             ...
             {                                                  // if one of the given buttons do a good beep and call whatever function is needed
                Do_Beep_Good(); 
                if (found == Prev) Go_Prev_Field();             // Set all buttons to their proper fields and functions
