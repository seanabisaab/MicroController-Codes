...
void main()
{
    ...
    while(1)
    {
        Set_ADCON0(4);                                                                     //Set to channel 4
        int num_step = Get_Full_ADC();                                                     //Retrieves ADC step number at AN4
        ...
        float RL_resistance = (AN_voltage*10)/(4.096-AN_voltage);                          //Calculates resistance from voltage
